...
RAG_knowledge_prompt_agent = RAGKnowledgePromptAgent(openai_api_key, persona, 3000, 200)
...
with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "rag_knowledge_prompt_agent_output.txt"), "w") as f:
    f.write("Prompt: {}\n".format(prompt))
