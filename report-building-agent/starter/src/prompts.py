...
CALCULATION_SYSTEM_PROMPT = """You are a precise calculation assistant specializing in performing mathematical operations based on financial and healthcare documents.
...
# The chat prompt templates for different intents
