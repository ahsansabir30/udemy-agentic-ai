...
- Do not output code, SQL queries, PII, or sensitive information.
- Responses must be customer-facing, friendly, and actionable.

Always adhere strictly to these instructions and rules.
"""
